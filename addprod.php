                                ...
                                if (!empty($_SESSION["cart"])) {
                                  ...
                                  foreach($_SESSION["cart"] as $keys => $values){
                                    ...
                                    <tr>
                                      ...
                                      <td>N <?php echo $values["price"]; ?></td>
                                      <td>N <?php echo $values["quantity"] * $values["price"]; ?></td>
                                    </tr>
                                    <?php 
                                    $name= $values["name"];
...
<div class="container">
  ...
  <form role="form" method="post" action="transactionsave.php?action=adds">
                            ...
                            <h4>N <?php echo $_SESSION['mm']; ?></h4><br>
                            </div> 
                            <div class="col-lg-7" >
                            ...
                            <div align="right" class="col-lg-4">
                            <h4>N <?php echo $_SESSION['mm']+150; ?></h4><br>
                            </div>                            
                            </div>
                            ...
                            <div>
                            <h4>Click Submit Order and Make payment to this account number with. <br>
                            Account Name:Ralph Computers <br> Account Number: **********<br> Bank Name: Access Bank</h4><br>
                             Then Check Your <a href="order.php">List of Orders</a>  to know your Order Status
                            </div>  
