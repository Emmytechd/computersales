...
?>
 ...
 <div class="card">
            ...
            <div class="card-header">
             ...
             <center><h2>Ralph Computers</h2><p style="font-size: 20px">GSM Village Wuse II,  <br>Abuja </p></center>
         </div>
...
?>
                                ...
                                <tr>
                                  ...
                                  <td ><br><h5> N <?php echo $zz-150; ?></h5></td>
                                </tr>
                                <tr>
            ...
            $result = mysqli_query($db, "SELECT * FROM tbltransacdetail 
              ...
              {   
               $stats = $row['status'];
                             ...
                             if ($stats=='Confirmed') {
                             ?>
                             <h5>Please print this as a proof of purchase</h5>
                            <p> We hope you enjoy your purchased products. Have a nice day! While you await for the arrival of the supplier</p>

                            <p> Sincerely.</p>

                           <h4>Ralph Computers</h4>
                           <?php }else{
        ...
        <!--   <h5 align="right" style="margin-right: : 150px">Total Price : N <?php echo $zz; ?></h5> -->
          </div>
